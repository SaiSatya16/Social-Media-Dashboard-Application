const About =  Vue.component('about', {
    ...
    <p>Frameworks: Flask, Java Servlet, Vue.js, RESTfulAPI</p>
    ...
    <h3>Full Stack Grocery Store, Modern Application Development - II</h3>
    <p>Indian Institute of Technology, Madras | sep 2023 - Dec 2023</p>
    <ul>
      <li>This project is a sophisticated multi‑user grocery store web application that seamlessly integrates Vue.js for the front end and Flask for the
      back end. This application is designed to provide a comprehensive and seamless grocery shopping experience. It merges frontend and
      backend technologies to ensure smooth interactions for users, admins, and managers. Project Grade Achieved: 83%</li>
    </ul>



    <h3>Grocery Store REST API, Modern Application Development - I</h3>
    ...
    <ul>
    <li>Objective:Developed a Rhythm Generator,that generates random musical rhythm based on instruments and mood using ComMU dataset, a collection of over 10,000 MIDI files of various genres and styles. Using vertically stacked time‐valued sequences and REMI format, the Transformer‐XL approach achieved a 15% improvement in composition quality, surpassing benchmarks like Music Transformer and DeepJ. Awarded Best Project by Data Science Community SRM for 2022‐23 term.Currently progressing for Publication.</li>
</ul>
    ...
    <ul>
      <li>2024: Selected for 2024 Mitacs Globalink Research Internship, University of Calgary, Canada</li>
      <li>2024: Diploma in Programming, from Indian Institute of Technology, Madras India</li>
